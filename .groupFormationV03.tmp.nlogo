...
to go
  ...
  if add-opinion? [  ;; Active only for scenarios indicated by ADD-OPINION? == TRUE.
    if opinions < length [opinion-position] of turtle 0 [  ;; Rest will be activated only when one more opinion has not been added yet.
      if mean [mean Record] of turtles > adding or ticks >  [  ;; Sub-routine is done once, when average of RECORD averages exceeds firstly 0.9. (Might be parametrized...)
...
278
file-name
Sims/Sims02_10_100_0.25_49_2_1_0.1_uniform_1_openly-listen.csv
1
0
String
