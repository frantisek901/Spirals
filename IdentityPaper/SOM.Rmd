...
But this is my conclusion now and here, there are still certain doubts. Firstly, we compare here again very aggregated results, for each comparison we employ 28,800 simulations distributed in two groups with ratio 1:4. I probably should compare them on one-on-one basis, take these 5 observation same in all parameters except `SPIRO_STD` and then compute deviance of each of four Step 4 observations from respective one Step 3 observation (`SPIRO_STD` equal to 0 for checking reason, other 3 for measuring difference between Steps).   
