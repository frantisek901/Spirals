...
to setup
  ...
  ask turtles [
    ...
    consume-random-number  ;;for 'get-speaking'
    consume-random-number  ;; for 'speaking'
...
to consume-random-number
  set random-junk random-float 1
end
...
to compute-initial-macro-state-of-simulation
  ...
  if opinions > 1 [set mean_op2_start mean [item 1 opinion-position] of turtles]
  if opinions > 2 [set mean_op3_start mean [item 2 opinion-position] of turtles]
  if opinions > 3 [set mean_op4_start mean [item 3 opinion-position] of turtles]
  set sd_op1_start standard-deviation [item 0 opinion-position] of turtles
  if opinions > 1 [set sd_op2_start standard-deviation [item 1 opinion-position] of turtles]
  if opinions > 2 [set sd_op3_start standard-deviation [item 2 opinion-position] of turtles]
  if opinions > 3 [set sd_op4_start standard-deviation [item 3 opinion-position] of turtles]

  ;; For last measures we need to sort turtles regarding their opinion
  let lops1 sort-by < [item 0 opinion-position] of turtles
  let lops2 []
  if opinions > 1 [set lops2 sort-by < [item 1 opinion-position] of turtles]
  let lops3 []
  if opinions > 2 [set lops3 sort-by < [item 2 opinion-position] of turtles]
  let lops4 []
  if opinions > 3 [set lops4 sort-by < [item 3 opinion-position] of turtles]
  set median_op1_start item 64 lops1
  if opinions > 1 [set median_op2_start item 64 lops2]
  if opinions > 2 [set median_op3_start item 64 lops3]
  if opinions > 3 [set median_op4_start item 64 lops4]
  set lower_op1_start mean (list item 31 lops1 item 32 lops1)
  if opinions > 1 [set lower_op2_start mean (list item 31 lops2 item 32 lops2)]
  if opinions > 2 [set lower_op3_start mean (list item 31 lops1 item 32 lops1)]
  if opinions > 3 [set lower_op4_start mean (list item 31 lops2 item 32 lops2)]
  set upper_op1_start mean (list item 95 lops1 item 96 lops1)
  if opinions > 1 [set upper_op2_start mean (list item 95 lops2 item 96 lops2)]
  if opinions > 2 [set upper_op3_start mean (list item 95 lops1 item 96 lops1)]
  if opinions > 3 [set upper_op4_start mean (list item 95 lops2 item 96 lops2)]
end
...
to compute-final-macro-state-of-simulation
  ...
  if opinions > 1 [set mean_op2_final mean [item 1 opinion-position] of turtles]
  if opinions > 2 [set mean_op3_final mean [item 2 opinion-position] of turtles]
  if opinions > 3 [set mean_op4_final mean [item 3 opinion-position] of turtles]
  set sd_op1_final standard-deviation [item 0 opinion-position] of turtles
  if opinions > 1 [set sd_op2_final standard-deviation [item 1 opinion-position] of turtles]
  if opinions > 2 [set sd_op3_final standard-deviation [item 2 opinion-position] of turtles]
  if opinions > 3 [set sd_op4_final standard-deviation [item 3 opinion-position] of turtles]
  ...
  if opinions > 1 [set median_op2_final item 64 lops2]
  if opinions > 2 [set median_op3_final item 64 lops3]
  if opinions > 3 [set median_op4_final item 64 lops4]
  set lower_op1_final mean (list item 31 lops1 item 32 lops1)
  if opinions > 1 [set lower_op2_final mean (list item 31 lops2 item 32 lops2)]
  if opinions > 2 [set lower_op3_final mean (list item 31 lops1 item 32 lops1)]
  if opinions > 3 [set lower_op4_final mean (list item 31 lops2 item 32 lops2)]
  set upper_op1_final mean (list item 95 lops1 item 96 lops1)
  if opinions > 1 [set upper_op2_final mean (list item 95 lops2 item 96 lops2)]
  if opinions > 2 [set upper_op3_final mean (list item 95 lops1 item 96 lops1)]
  if opinions > 3 [set upper_op4_final mean (list item 95 lops2 item 96 lops2)]
end

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; HARDCODED VARIABLES ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;to-report use_identity?
;  report true
;end

;; Sorry Ashwin! After preparing 15 experiments I realized it's hardcoded, but in all experiments it's set only as TRUE, so I'm changing it here :-(
@#$#@#$#@
GRAPHICS-WINDOW
219
10
...
<experiments>
  <experiment name="regularExperimentPart74" repetitions="1" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="RS" first="1" step="1" last="240"/>
  ...
  <experiment name="regularExperimentPart72" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>betweenness_start</metric>
  ...
  <experiment name="regularExperimentPart73" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>betweenness_start</metric>
  ...
  <experiment name="regularExperimentPart75" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>betweenness_start</metric>
  ...
  <experiment name="regularExperimentPart76" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>betweenness_start</metric>
  ...
  <experiment name="regularExperimentPart77" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>betweenness_start</metric>
  ...
  <experiment name="polarizedStartPart91" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>betweenness_start</metric>
    ...
    <steppedValueSet variable="boundary" first="0.04" step="0.01" last="0.5"/>
    <steppedValueSet variable="id_threshold" first="0.06" step="0.04" last="0.82"/>
    <enumeratedValueSet variable="polrzd_opnns">
      <value value="1"/>
      <value value="2"/>
      <value value="3"/>
  ...
  <experiment name="polarizedStartPart94" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>betweenness_start</metric>
    ...
    <steppedValueSet variable="boundary" first="0.05" step="0.02" last="0.49"/>
    <steppedValueSet variable="id_threshold" first="0.05" step="0.04" last="0.85"/>
    <enumeratedValueSet variable="polrzd_opnns">
      <value value="1"/>
      <value value="2"/>
  ...
  <experiment name="polarizedStartPart92" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>betweenness_start</metric>
    ...
    <steppedValueSet variable="boundary" first="0.04" step="0.01" last="0.5"/>
    <steppedValueSet variable="id_threshold" first="0.07" step="0.04" last="0.83"/>
    <enumeratedValueSet variable="polrzd_opnns">
      <value value="1"/>
      <value value="2"/>
      <value value="3"/>
  ...
  <experiment name="polarizedStartPart93" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>betweenness_start</metric>
    ...
    <steppedValueSet variable="boundary" first="0.04" step="0.01" last="0.5"/>
    <steppedValueSet variable="id_threshold" first="0.08" step="0.04" last="0.84"/>
    <enumeratedValueSet variable="polrzd_opnns">
      <value value="1"/>
      <value value="2"/>
      <value value="3"/>
  ...
  <experiment name="robCheck010" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
  ...
  <experiment name="robCheck020" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
  ...
  <experiment name="robCheck030" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
  ...
  <experiment name="robCheck040" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
  ...
  <experiment name="robCheck050" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
  ...
  <experiment name="robCheck060" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
  ...
  <experiment name="robCheck070" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
    ...
    <metric>upper_op3_final</metric>
    <metric>upper_op4_final</metric>
    <steppedValueSet variable="RS" first="61" step="1" last="70"/>
    <enumeratedValueSet variable="id_threshold">
      <value value="0.39"/>
      <value value="0.49"/>
      <value value="0.59"/>
  ...
  <experiment name="robCheck080" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
    ...
    <metric>upper_op3_final</metric>
    <metric>upper_op4_final</metric>
    <steppedValueSet variable="RS" first="71" step="1" last="80"/>
    <enumeratedValueSet variable="id_threshold">
      <value value="0.39"/>
      <value value="0.49"/>
      <value value="0.59"/>
  ...
  <experiment name="robCheck090" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
    ...
    <metric>upper_op3_final</metric>
    <metric>upper_op4_final</metric>
    <steppedValueSet variable="RS" first="81" step="1" last="90"/>
    <enumeratedValueSet variable="id_threshold">
      <value value="0.39"/>
      <value value="0.49"/>
      <value value="0.59"/>
  ...
  <experiment name="robCheck100" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
    ...
    <metric>upper_op3_final</metric>
    <metric>upper_op4_final</metric>
    <steppedValueSet variable="RS" first="91" step="1" last="100"/>
    <enumeratedValueSet variable="id_threshold">
      <value value="0.39"/>
      <value value="0.49"/>
      <value value="0.59"/>
  ...
  <experiment name="robCheck110" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
  ...
  <experiment name="robCheck120" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
    ...
    <metric>upper_op3_final</metric>
    <metric>upper_op4_final</metric>
    <steppedValueSet variable="RS" first="111" step="1" last="120"/>
    <enumeratedValueSet variable="id_threshold">
      <value value="0.39"/>
      <value value="0.49"/>
      <value value="0.59"/>
  ...
  <experiment name="robCheck130" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
    ...
    <metric>upper_op3_final</metric>
    <metric>upper_op4_final</metric>
    <steppedValueSet variable="RS" first="121" step="1" last="130"/>
    <enumeratedValueSet variable="id_threshold">
      <value value="0.39"/>
      <value value="0.49"/>
      <value value="0.59"/>
  ...
  <experiment name="robCheck140" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
    ...
    <metric>upper_op3_final</metric>
    <metric>upper_op4_final</metric>
    <steppedValueSet variable="RS" first="131" step="1" last="140"/>
    <enumeratedValueSet variable="id_threshold">
      <value value="0.39"/>
      <value value="0.49"/>
      <value value="0.59"/>
  ...
  <experiment name="robCheck150" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
    ...
    <metric>upper_op3_final</metric>
    <metric>upper_op4_final</metric>
    <steppedValueSet variable="RS" first="141" step="1" last="150"/>
    <enumeratedValueSet variable="id_threshold">
      <value value="0.39"/>
      <value value="0.49"/>
      <value value="0.59"/>
  ...
  <experiment name="robCheckNoID050" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
  ...
  <experiment name="robCheckNoID100" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
    ...
    <metric>upper_op3_final</metric>
    <metric>upper_op4_final</metric>
    <steppedValueSet variable="RS" first="51" step="1" last="100"/>
    <enumeratedValueSet variable="id_threshold">
      <value value="0.49"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="opinions">
  ...
  <experiment name="robCheckNoID150" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="366"/>
    <metric>normalized_polarization_start</metric>
    ...
    <metric>upper_op3_final</metric>
    <metric>upper_op4_final</metric>
    <steppedValueSet variable="RS" first="101" step="1" last="150"/>
    <enumeratedValueSet variable="id_threshold">
      <value value="0.49"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="opinions">
