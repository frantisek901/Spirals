...
to setup
  ...
  ;; Checking whether Twitters positions has enough dimensions
...
to setup-Twitters
  ...
  create-Twitters NT [
    set shape "house"
    set ID who - min [who] of Twitters
    set tw-position []
  ]
  ask Twitters [
    foreach range nd [x ->
      let y item x matOp
      set tw-position lput (item ID y) tw-position
    ]
