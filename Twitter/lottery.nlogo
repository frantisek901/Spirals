...
to setup
  ...
  ask patches with [ pxcor mod 5 = 0 and pycor mod 5 = 0 ] [
    sprout 1 [
      set size 0.1 + random-float delta ; vary the size of the turtles
...
to go
  ask rnd:weighted-one-of turtles [ size ^ alpha ] [
...
"" "clear-plot"
PENS
"default" 0.001 2 -16777216 true "" "ask turtles [plotxy size winnings]"
